...
.. rubric:: Snackbars provide brief messages about app processes at th"""
Components/Snackbar
===================
...
<Snackbar>:
    ...
    BoxLayout:
        ...
        canvas:
            Color:
                rgba: get_color_from_hex('323232') if not root.bg_color else root.bg_color
            Rectangle:
                pos: self.pos
                size: self.size
        ...
        MDLabel:
            ...
            text_color: root.text_color if root.text_color else get_color_from_hex('ffffff')
            shorten: True
            shorten_from: 'right'
            pos_hint: {'center_y': .5}
"""
...
class Snackbar(MDFloatLayout):
    ...
    """ Snackbar bg_color of the snackbar by Bonavee"""

    text_color = ListProperty()
    """Text color by Bonavee"""
    ...
    def __init__(self, **kwargs):
        ...
        if self.button_text != "":
            button = MDFlatButton(
                text=self.button_text, text_color= (0,0,0,1)#(1, 1, 1, 1)
            )
